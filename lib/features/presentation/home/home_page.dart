...
import 'package:movieapp/widgets/common/movie_card.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Movies'), backgroundColor: Colors.black, foregroundColor: Colors.white),
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                ...
                action: SnackBarAction(
                  ...
                  onPressed: () => context.read<HomeCubit>().clearError(),
                ),
              ),
            );
          }
